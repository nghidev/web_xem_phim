...
<head>
    ...
    <link rel="stylesheet" id="bootstrap-css" href="{{ asset('fe/css/bootstrap.min.css?ver=5.7.2') }}" media="all">
    <link rel="stylesheet" id="style-css" href="{{ asset('fe/css/style.css?ver=5.7.2') }}" media="all">
    <link rel="stylesheet" id="wp-block-library-css" href="{{ asset('fe/css/style.min.css?ver=5.7.2') }}" media="all">
    <script type="text/javascript" src="{{ asset('fe/js/jquery.min.js?ver=5.7.2') }}" id="halim-jquery-js"></script>
    ...
    <style>
        #header .site-title {
            background: url(https://phimmoiyy.net/wp-content/uploads/2023/03/phimmoi.png) no-repeat top left;
...
<body class="home blog halimthemes halimmovies" data-masonry="">
                ...
                <div class="collapse navbar-collapse" id="halim">
                    <div class="menu-menu_1-container">
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            <li class="mega"><a title="Phim Mới" href="{{ route('categories', ['id' => $item->id, 'slug' => $item->slug]) }}">{{ $item->title }}</a></li>
                            @endforeach
                            ...
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    ...
                                    <li><a title="{{ $item->title }}" href="{{ route('genres', ['id' => $item->id, 'slug' => $item->slug]) }}">{{ $item->title }}</a></li>
                                @endforeach
                            ...
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    ...
                                    <li><a title="{{ $item->title }}" href="{{ route('countries', ['id' => $item->id, 'slug' => $item->slug]) }}">{{ $item->title }}</a></li>
    ...
    <script type="text/javascript" src="{{ asset('fe/js/bootstrap.min.js?ver=5.7.2') }}" id="bootstrap-js"></script>
    <script type="text/javascript" src="{{ asset('fe/js/owl.carousel.min.js?ver=5.7.2') }}" id="carousel-js"></script>
    <script type="text/javascript" src="{{ asset('fe/js/halimtheme-core.min.js?ver=1626273138') }}" id="halim-init-js"></script>
