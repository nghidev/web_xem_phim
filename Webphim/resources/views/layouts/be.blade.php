...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
      ...
      addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
        ...
        <link href="{{ asset('be/css/owl.carousel.css') }}" rel="stylesheet" />
        <script src="{{ asset('be/js/owl.carousel.js') }}"></script>
        <script>
            $(document).ready(function() {
    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
                ...
                <aside class="sidebar-left">
                    <nav class="navbar navbar-inverse">
                        <div class="navbar-header">
                            ...
                            <h1>
                                <a class="navbar-brand" href="{{ route('admin') }}"><span class="fa fa-area-chart"></span>
                                    Admin<span class="dashboard_text">Design dashboard</span></a>
                            </h1>
                        </div>
            ...
            @if ($__env->yieldContent('content'))
                <!-- Đoạn mã này sẽ được thực thi nếu 'content' đã được định nghĩa -->
                <div id="page-wrapper">
                    <div class="main-page">
                        @yield('content')
                        {{-- <div class="col_3"> --}}
                  ...
                  <!-- for amcharts js -->
                  <script src="be/js/amcharts.js"></script>
                  <script src="be/js/serial.js"></script>
                  <script src="be/js/export.min.js"></script>
                  <link rel="stylesheet" href="be/css/export.css" type="text/css" media="all" />
                  <script src="be/js/light.js"></script>
                  <!-- for amcharts js -->
                  <script src="be/js/index1.js"></script>
                  <div class="charts">
            ...
            @else
                <!-- Đoạn mã này sẽ được thực thi nếu 'content' chưa được định nghĩa -->
                <div id="page-wrapper">
                    <div class="main-page">
                        {{-- @yield('content') --}}
                        <div class="col_3">
                                        ...
                                        <div class="activity-row activity-row1">
                                            <div class="single-bottom">
                                                <ul>
                                                    <li>
                                                        <input type="checkbox" id="brand" value="" />
                                                        <label for="brand"><span></span> Integer sollicitudin
                                                            lacinia
                                                            condimentum.</label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="brand1" value="" />
                                                        <label for="brand1"><span></span> ligula sit amet hendrerit
                                                            init
                                                            lorem.</label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="brand2" value="" />
                                                        <label for="brand2"><span></span> Donec aliquam dolor eu
                                                            augue
                                                            condimentum.</label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="brand9" value="" />
                                                        <label for="brand9"><span></span> at tristique Pain that
                                                            produces
                                                            no
                                                            resultant.</label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="brand8" value="" />
                                                        <label for="brand8"><span></span> Nulla finibus rhoncus
                                                            turpis
                                                            quis
                                                            tristique.</label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="brand7" value="" />
                                                        <label for="brand7"><span></span> Cupidatat non proident
                                                            Praising
                                                            pain.</label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="brand3" value="" />
                                                        <label for="brand3"><span></span> libero vel elementum
                                                            euismod,
                                                            mauris
                                                            tellus</label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="brand4" value="" />
                                                        <label for="brand4"><span></span> Donec aliquam dolor eu
                                                            augue
                                                            condimentum.</label>
                                                    </li>
                                                    <li>
                                                        <input type="checkbox" id="brand5" value="" />
                                                        <label for="brand5"><span></span> Orci varius natoque
                                                            penatibus
                                                            et
                                                            magnis dis.</label>
                                                    </li>
