...
@section('content')
    {{-- @foreach ($watch->episodes as $episode)
        {{ $episode->id }}
    @endforeach --}}
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="yoast_breadcrumb hidden-xs"><span><span><a
                                            href="">{{ $watch->category->title }}</a> » <span><a
                                                href="danhmuc.html">{{ $watch->country->title }}</a> » <span
                                                class="breadcrumb_last"
                                                aria-current="page">{{ $watch->title }}</span></span></span></span></div>
                        </div>
                    </div>
                </div>
                                           ...
                                           @foreach ($watch->episodes as $episode)
                                               <li class="halim-episode">
                                                   <span class="halim-btn halim-btn-2 active halim-info-1-1 box-shadow"
                                                      ...
                                                      <a href="{{ route('episode', ['id' => $watch->id, 'slug' => $episode->slug, 'episode_id'=>$episode->id  ]) }}">Tập {{ $episodeCount }}</a> 
                                                   </span>
                                               </li>
                                               @php
                                                   $episodeCount++;
