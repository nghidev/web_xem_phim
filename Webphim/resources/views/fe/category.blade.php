                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">
                                           @if (isset($danhmuc))
                                           {{ $danhmuc->title }} 
                                           @elseif(isset($theloai))
                                           {{ $theloai->title }} 
                                           @else
                                           {{ $quocgia ->title }} 
                                             
                                           @endif 
                                        </a> » <span class="breadcrumb_last" aria-current="page">2020</span></span></span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        @foreach ($movies as $item)
                            <article class="col-md-3 col-sm-3 col-xs-6 thumb grid-item post-27021">
                                <div class="halim-item">
                                    <a class="halim-thumb"
                                        href="{{ route('detail', ['id' => $item->id, 'slug' => $item->slug]) }}"
                                        title="{{ $item->title }}" title="VŨNG LẦY PHẦN 1">
                                        <figure><img class="lazy img-responsive"
                                                src="{{ asset('storage/images/' . $item->image) }}" alt="VŨNG LẦY PHẦN 1"
