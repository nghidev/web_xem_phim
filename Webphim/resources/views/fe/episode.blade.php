...
@section('content')
    {{-- @foreach ($episodeplus->episodes as $episode)
        {{ $episode->id }}
    @endforeach --}}
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="yoast_breadcrumb hidden-xs"><span><span><a
                                            href="">{{ $episodeplus->category->title }}</a> » <span><a
                                                href="danhmuc.html">{{ $episodeplus->country->title }}</a> » <span
                                                class="breadcrumb_last"
                                                aria-current="page">{{ $episodeplus->title }}</span></span></span></span></div>
                        </div>
                    </div>
                </div>
            ...
            <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
                <section id="content" class="test">
                    <div class="clearfix wrap-content">
                        ...
                        <iframe width="100%" height="500" src="{{ $link->link }}" title="YouTube video player"
                            frameborder="0"
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active server-1" id="server-0">
                                    <div class="halim-server">
                                       @if ($episodeplus->episodes->count() > 1)
                                           ...
                                           @foreach ($episodeplus->episodes as $episode)
                                               <li class="halim-episode">
                                                   <span class="halim-btn halim-btn-2 active halim-info-1-1 box-shadow"
                                                       data-post-id="37976" data-server="1" data-episode="{{ $episodeCount }}"
                                                       data-position="first" data-embed="0"
                                                       data-title="Xem phim Tôi Và Chúng Ta Ở Bên Nhau - Tập {{ $episodeCount }} - Be Together - vietsub + Thuyết Minh"
                                                       data-h1="Tôi Và Chúng Ta Ở Bên Nhau - tập {{ $episodeCount }}">
                                                      <a href="{{ route('episode', ['id' => $episodeplus->id, 'slug' => $episode->slug, 'episode_id'=>$episode->id  ]) }}">Tập {{ $episodeCount }}</a> 
                                                   </span>
                                               </li>
                                               @php
                                                   $episodeCount++;
                ...
                <section class="related-movies">
                    <div id="halim_related_movies-2xx" class="wrap-slider">
                        ...
                        <div id="halim_related_movies-2" class="owl-carousel owl-theme related-film owl-loaded owl-drag">
                            ...
                            <div class="owl-stage-outer">
                                <div class="owl-stage"
                                    style="transform: translate3d(-724px, 0px, 0px); transition: all 0s ease 0s; width: 2353px;">
                                    <div class="owl-item cloned" style="width: 177px; margin-right: 4px;">
                                        <article class="thumb grid-item post-38494">
                                            <div class="halim-item">
                                                <a class="halim-thumb" href="chitiet.html"
                                                    title="Câu Chuyện Kinh Dị Cổ Điển">
                                    ...
                                    <div class="owl-item active" style="width: 177px; margin-right: 4px;">
                                        <article class="thumb grid-item post-38494">
                                            <div class="halim-item">
                                                <a class="halim-thumb" href="chitiet.html"
                                                    title="Câu Chuyện Kinh Dị Cổ Điển">
                                    ...
                                    <div class="owl-item" style="width: 177px; margin-right: 4px;">
                                        <article class="thumb grid-item post-38494">
                                            <div class="halim-item">
                                                <a class="halim-thumb" href="chitiet.html"
                                                    title="Câu Chuyện Kinh Dị Cổ Điển">
                            ...
                            <div class="owl-nav">
                                <div class="owl-prev"><i class="hl-down-open rotate-left"></i></div>
                                <div class="owl-next"><i class="hl-down-open rotate-right"></i></div>
                            </div>
                            <div class="owl-dots">
